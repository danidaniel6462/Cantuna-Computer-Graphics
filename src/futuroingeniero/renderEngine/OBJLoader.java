...
public class OBJLoader {
	 ...
	 * 
	 * @param fileName ubicación y nombre del archivo el cual se desea importar
	 * @param loader variable para cargar los vbo dentro del los vao
	...
	public static RawModel loadObjModel(String fileName, Loader loader) {
		...
		try {
			// bucle infinito para leer todo el archivo hasta la última línea del .obj
			while (true) {
				...
				if (line.startsWith("v ")) {
					...
					// guardamos en la lista las posiciones encontradas en la línea de código anterior
					vertices.add(vertex);
		...
		// bucle creado para realizar la converción de la lista al arreglo de flotantes para los vértices posición e índices respectivamente
		int vertexPointer = 0;
	 ...
	 * @param vertexData cadena de datos de los vértices
	 * @param indices índices para poder unir los vértices del modelo
	 * @param textures coordenadas de la textura del objeto 3D
	 * @param normals normales para recibir correctamente la iluminación y renderizado de nuestro objeto
	 * @param textureArray lista de las coordenadas de la textura
	 * @param normalsArray lista de las normales del objeto
	 */
	private static void processVertex(String[] vertexData, List<Integer> indices,
			List<Vector2f> textures, List<Vector3f> normals, float[] textureArray,
			float[] normalsArray) {
		// variable para poder asociar los vectores posición, texturas y normales
		// para poder ponerlas en la posición correcta para poder dibujar correctamente el modelo
