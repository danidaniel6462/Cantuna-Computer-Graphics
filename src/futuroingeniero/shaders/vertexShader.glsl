...
// matriz de proyección para ajustarlo a la cámara 
uniform mat4 projectionMatrix;
// matriz de vista
uniform mat4 viewMatrix;
// posición de la luz, es un arreglo que tiene 4 luces, 1 por cada multiple luz
uniform vec3 luzPosicion[4];

// número de filas que tiene la textura atlas
